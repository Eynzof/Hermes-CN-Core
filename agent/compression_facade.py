...
class CompressionFacadeMixin:
    ...
    def _compress_context(
        ...
        focus_topic: str = None, force: bool = False, bypass_cooldown: bool = False, mode: str = None,
        ...
        ``mode`` (the compact tool's style guidance: "balanced"/"aggressive"/"retentive"/"technical")
        is forwarded to the compressor's summarizer.
        """
        ...
        try:
            ...
            def _run(fence=None, target_messages=None, same_turn_fallback_recovery=False):
                return compress_context(
                    ...
                    bypass_cooldown=bypass_cooldown or same_turn_fallback_recovery, mode=mode,
