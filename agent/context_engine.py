...
class ContextEngine(ABC):
    ...
    def compress(
        ...
        text for the handoff prompt; ``mode`` is the optional compaction mode
        ("balanced", "aggressive", "retentive", "technical") that selects the
        summarizer style guidance. Older engines may omit optional parameters — the
