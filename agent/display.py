...
def _cute_terminal(a: dict, result) -> str:
    """Terminal completion line; prefer the command actually executed (result JSON)."""
    ...
    display_cmd = result_cmd or a.get("command", "")
    return f"┊ 💻 $ {_cute_trunc(build_tool_preview('terminal', a) or display_cmd)}"
