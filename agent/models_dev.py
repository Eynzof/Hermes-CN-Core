...
_MODELS_DEV_CACHE_TTL = 4 * 3600  # 1 hour in-memory
...
def get_model_capabilities(
    ...
    if entry is not None:
        ...
        supports_pdf = supports_audio = supports_video = False
        supports_reasoning_control = open_weights = False
