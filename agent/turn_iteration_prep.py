...
def begin_iteration(
    ...
    api_call_count: Any, interrupted: Any, _turn_exit_reason: Any, turn_id: Any = None,
) -> IterationStart:
    ...
    # [CN-fork] P-017: dedup tracker step lifecycle. Seed the cross-step dedup state from
    # the previous iteration's tool calls before this iteration runs; the matching
    # ``end_step()`` lives in agent/turn_tool_round.py after the tools executed.
