...
def _spawn_detached_update(hermes_cmd, output_path, exit_code_path) -> None:
    ...
    if sys.platform == "win32":
        ...
        # choice" — same class of bug as the cron fix. Dispatch through
        # the hidden ``__update-gateway-helper`` CLI subcommand instead
        # (it runs the same capture-and-exit-code logic in-process).
