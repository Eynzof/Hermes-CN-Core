...
def _detect_openclaw_processes() -> list[str]:
    ...
    if sys.platform == "win32":
        ...
        try:
            ...
            result = bounded_probe_run(["powershell", "-NoProfile", "-Command", ps_with_utf8(ps_cmd)], timeout=5)
...
def _load_migration_module(script_path: Path):
    ...
    if spec is None or spec.loader is None:
        return None
    # Register in sys.modules so @dataclass can resolve the module (Python 3.14+ requires this for dynamically loaded modules).
