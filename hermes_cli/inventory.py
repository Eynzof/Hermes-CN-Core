        ...
        for model in row.get("models") or []:
            ...
            if meta is not None:
                entry.update({
                    ...
                    "context_window": int(meta.context_window) if meta.context_window is not None else None,
                    "max_output_tokens": int(meta.max_output_tokens) if meta.max_output_tokens is not None else None,
