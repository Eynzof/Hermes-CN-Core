...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "deepinfra": HermesOverlay(extra_env_vars=("DEEPINFRA_API_KEY",),
        base_url_override="https://api.deepinfra.com/v1/openai", base_url_env_var="DEEPINFRA_BASE_URL"),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "gmi": ("gmi-cloud", "gmicloud"), "fireworks": ("fireworks-ai", "fw"), "upstage": ("solar", "upstage-ai"),
    "deepinfra": ("deep-infra", "deepinfra-ai"),
