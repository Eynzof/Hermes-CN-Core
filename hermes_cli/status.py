...
_TERMINAL_ENV_ROWS = {
    ...
    "docker": (("Docker Image:", "TERMINAL_DOCKER_IMAGE", "python:3.14-slim", False),),
    "daytona": (("Daytona Image:", "TERMINAL_DAYTONA_IMAGE", "nikolaik/python-nodejs:python3.14-nodejs20", False),),
}
