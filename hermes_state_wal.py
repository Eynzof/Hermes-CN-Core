...
def _detect_cross_vm_fs(directory: str, mountinfo_path: str = "/proc/self/mountinfo") -> bool:
    ...
    # Only the platform default is gated: off Linux there is no /proc/self/mountinfo to read, but an
    # explicitly supplied mountinfo file (tests, forensics on a copied tree) is parsed on any host.
