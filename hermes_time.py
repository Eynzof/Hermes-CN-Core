...
def _resolve_timezone_name() -> str:
    ...
    try:
        ...
        try:
            ...
            # [CN-fork] errors="replace": a config.yaml written by a CN editor may not be
            # valid UTF-8; a decode error here must never break time resolution.
            cfg = (
                yaml.safe_load(config_path.read_text(encoding="utf-8", errors="replace")) or {}
