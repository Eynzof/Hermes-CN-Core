...
def _fetch_hindsight_api_version(api_url: str, api_key: str | None = None,
    ...
    try:
        with urllib.request.urlopen(req, timeout=timeout) as resp:  # noqa: S310
            data = orjson.loads(resp.read().decode("utf-8", errors="replace"))
    except Exception as exc:
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def is_available(self) -> bool:
        try:
            ...
            has_config = mode == "local_external" or bool(
    ...
    def sync_turn(self, user_content: str, assistant_content: str, *, session_id: str = "") -> None:
        ...
        self._session_turns.append(orjson.dumps(self._build_turn_messages(user_content, assistant_content)).decode('utf-8'))
    ...
    def handle_tool_call(self, tool_name: str, args: dict, **kwargs) -> str:
        ...
        try:
            return orjson.dumps({"result": handler(self, args)}).decode('utf-8')
        except Exception as e:
