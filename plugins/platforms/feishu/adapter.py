...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _build_outbound_payload(
        ...
        # Current Feishu clients render markdown tables in post-type md
        # elements. Keep table content on the common markdown path instead of
        # exposing raw pipe-and-dash source as plain text (#52786).
        # ``prefer_post`` also keeps every chunk of a split markdown document
        # on the same payload type (#26841).
