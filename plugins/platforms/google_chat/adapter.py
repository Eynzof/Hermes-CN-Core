...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def _load_cached_bot_id(self) -> Optional[str]:
        try:
            return orjson.loads(self._bot_id_cache_path().read_text(encoding="utf-8")).get("bot_user_id") or None
    ...
    def _save_cached_bot_id(self, bot_user_id: str) -> None:
        try:
            ...
            path.write_text(orjson.dumps({"bot_user_id": bot_user_id}).decode('utf-8'), encoding="utf-8")
        except OSError:
