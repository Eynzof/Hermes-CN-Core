...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(
        ...
        try:
            ...
            loaded = ensure_lmstudio_model_loaded(
                self.model,
                self.base_url,
            ...
            # next render tick.
            ctx_len = getattr(loaded, "context_length", loaded)
            if isinstance(ctx_len, int) and not isinstance(ctx_len, bool) and ctx_len > 0:
