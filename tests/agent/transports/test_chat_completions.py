...
class TestChatCompletionsBuildKwargs:
    ...
    def test_explicit_reasoning_config_wins_over_auto_enable(self, transport):
        ...
        # [F12] The explicit disable is what wins: _auto_enable_reasoning_from_history
        # returns the caller's dict unchanged (even a disabled one), and the
        # supports_reasoning path maps enabled=False to effort "none" — never re-enabling
        # an explicit "thinking off" (agent/transports/chat_completions.py:568).
