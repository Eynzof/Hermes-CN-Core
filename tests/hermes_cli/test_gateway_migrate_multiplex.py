...
@pytest.mark.skipif(
    sys.platform == "win32",
    reason="POSIX-only: gateway_identity() resolves a system unit's User= through NSS "
    "(pwd.getpwnam), which Windows does not have; systemd units are never present there",
)
