...
@pytest.mark.skipif(
    sys.platform == "win32",
    reason="POSIX-only: forces sys.platform='linux' to reach _kill_pids_posix, which "
    "needs signal.SIGKILL and gateway.status' fcntl import — neither exists on Windows",
)
