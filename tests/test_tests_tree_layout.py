...
_NON_MIRROR_DIRS = {
    ...
    # Cross-cutting performance suite (benchmarks of agent init, compression,
    # tool dispatch, Windows spawn cost...). It mirrors no single source package
    # by construction, and upstream's own equivalent (tests/perf_guards/) is here
    # for the same reason; upstream has no tests/performance/ of its own.
    "performance",
}
