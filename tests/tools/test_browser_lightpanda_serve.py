...
class TestFindBinary:
    @pytest.mark.skipif(sys.platform == "win32", reason="Lightpanda ships no Windows build: find_lightpanda_binary() returns None and launch_lightpanda() answers with the Windows-specific engine message")
