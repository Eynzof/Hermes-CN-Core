...
class TestVaultStore:
    ...
    @pytest.mark.skipif(sys.platform == "win32", reason="POSIX mode bits: Windows chmod only toggles the read-only bit, so owner-only 0600 lock files cannot be asserted there")
