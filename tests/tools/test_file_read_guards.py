...
class TestFileDedup(unittest.TestCase):
    ...
    def test_write_allows_large_file_that_quotes_status_text(self, mock_ops):
        ...
        mock_ops.return_value = fake
        # The merged-in read-before-write guard refuses to replace a file this task has
        # never read; read it first, the way a real session does.
        read_file_tool(self._tmpfile, task_id="guard")
...
class TestDedupResetOnCompression(unittest.TestCase):
    ...
    def test_first_post_compaction_read_recovers_exact_content(self, mock_ops):
        ...
        r_again = orjson.loads(read_file_tool(self._tmpfile, task_id="comp"))
