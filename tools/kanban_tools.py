...
def _redact_metadata(metadata: dict) -> Optional[dict]:
    ...
    try:
        return orjson.loads(redact_sensitive_text(orjson.dumps(metadata).decode('utf-8'), force=True))
...
def _handle_show(args: dict, **kw) -> str:
    ...
    with _board(args.get("board")) as (kb, conn):
        ...
        return orjson.dumps({
            ...
            "worker_context": kb.build_worker_context(conn, tid)}).decode('utf-8')
...
def _handle_list(args: dict, **kw) -> str:
    ...
    with _board(args.get("board")) as (kb, conn):
        ...
        return orjson.dumps({
            ...
            "promoted": promoted}).decode('utf-8')
