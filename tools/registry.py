...
class ToolRegistry:
    ...
    def get_entry(
        ...
        *,
        ...
        # P-043: lazily import the module providing this tool before lookup —
        # the fork's lazy tool index must stay lazy (test_accelerator_* and
        # get_tool_definitions cache isolation depend on it).
