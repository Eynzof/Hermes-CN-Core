...
def _discover(
    ...
    if not raw_results and not title_result:
        ...
        return orjson.dumps(_empty_payload).decode('utf-8')
    ...
    return orjson.dumps(_final_payload).decode('utf-8')
    ...
    *,
    ...
    if isinstance(session_id, str) and session_id.strip():
        ...
        if located is not None:
            try:
                found = orjson.loads(_read_session(located, sid, link_profile=owner))
            finally:
                located.close()
