...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search Hermes conversation history in the local session DB, or scroll "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "session_id": {
                "type": "string",
                "description": (
                    "Scroll shape. Session to read inside (from a prior discovery "
                    "result). Must be paired with around_message_id."
                ),
            },
            "around_message_id": {
                "type": "integer",
            ...
            "window": {
                "type": "integer",
                "description": (
                    "Scroll only. Messages on each side of the anchor (anchor always "
