...
def _(rid, params: dict) -> dict:
    ...
    if not isinstance(raw_text, str):
        # [CN-fork] P-056 — Non-string text (list/None/number) used to skip
        # sanitization and flow raw into turn handling, surfacing as an opaque
        # -32000 handler error. Reject it at the envelope layer with a proper
