...
def slug_for(path: Path) -> str:
    ...
    Always POSIX-separated: the slug becomes a URL path in llms.txt / llms-full.txt, and the
    native separator would make those links 404 when this runs on Windows.
    """
